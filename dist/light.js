...
var ENS = require('eth-ens-namehash');
...
var BBFarmAbi = require('./smart_contracts/BBFarm.abi.json');
var PaymentsAbi = require('./smart_contracts/SVPayments.abi.json');
var AuxAbi = require('./smart_contracts/AuxAbi.abi.json');
var AuctionAbi = require('./smart_contracts/CommAuctionIface.abi.json');
var ERC20Abi = require('./smart_contracts/ERC20.abi.json');
...
exports.resolveEnsAddress = function (_a, ensName) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, resolver.methods.addr(ENS.hash(ensName)).call()];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, aux.methods.getBBFarmAddressAndBallotId(backendAddress, indexAddress, democHash, nthBallot).call()];
                case 1:
                    ...
                    return [4 /*yield*/, aux.methods.getBallotDetails(id, bbFarmAddress, userEthAddress).call()];
                case 2:
