...
export declare const getBallotObjectFromS3: (archiveUrl: any, ballotSpecHash: any) => Promise<any>;
export declare const getBallotObjectFromIpfs: (ballotSpecHash: any) => Promise<any>;
