 ...
 */
export const initializeSvLight = (netConf) => __awaiter(this, void 0, void 0, function* () {
...
export const getContractAddresses = ({ svNetwork }) => __awaiter(this, void 0, void 0, function* () {
    ...
    return {
        ...
        delegationAddress: yield resolveEnsAddress({ resolver }, delegationEnsName),
 ...
 * @returns {Promise<any>}
 */
export const getUnsafeEd25519Delegations = (stellarPK, svNetwork) => __awaiter(this, void 0, void 0, function* () {
 ...
 * @param opts
 */
export const submitEd25519Delegation = (ethNetConf, dlgtRequest, stellarPK, _signature, opts) => __awaiter(this, void 0, void 0, function* () {
