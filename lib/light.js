...
const ballotBox_1 = require("./ballotBox");
// Lovely ABIs
 ...
 */
exports.initializeSvLight = (netConf, opts) => __awaiter(this, void 0, void 0, function* () {
    const _opts = new InitSvLightOpts(opts, Object.assign({}, netConf, { useWebsockets: false }));
    const { mkProvider } = _opts.useWebsockets
...
exports.getDemocNthBallot = (svNetwork, democBallotInfo) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (namespaceBytes[0] != 0 && namespaceBytes[1] != 0) {
        const foreignBBFarmDetails = yield _getForeignBallotInfo(svNetwork, ballotId, bbFarmAddress, userEthAddress);
...
const _getForeignBallotInfo = (svNetwork, ballotId, bbFarmAddress, userEthAddress) => __awaiter(this, void 0, void 0, function* () {
    ...
    const { networkId, chainId, remoteBBFarmAddress } = ballotBox_1.explodeForeignNetDetails(votingNetworkDetails);
    ...
    return yield remoteBBFarmContract.methods.getDetails(ballotId, userEthAddress).call();
});
/**
...
exports.getDemocBallots = (svNetwork, democHash, userEthAddress) => __awaiter(this, void 0, void 0, function* () {
    ...
    for (let i = 0; i < numBallots; i++) {
        const ballotInfo = yield exports.getDemocNthBallot(svNetwork, { democHash: democHash, nthBallot: i, userEthAddress });
 ...
 * @param opts
 */
exports.submitEd25519Delegation = (ethNetConf, dlgtRequest, stellarPK, _signature, networkName, opts) => __awaiter(this, void 0, void 0, function* () {
...
exports.getTxReciept = (netConf, txId) => __awaiter(this, void 0, void 0, function* () {
    const { httpProvider } = netConf;
    const web3 = new Web3(httpProvider);
    return yield web3.eth.getTransactionReceipt(txId);
});
